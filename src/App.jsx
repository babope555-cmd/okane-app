      ...
      <div style={{ padding: "20px 20px 100px" }}>
        ...
        {level >= 5 && (() => {
          ...
          return (
            <div style={{ background: "white", borderRadius: 20, padding: "18px 18px 16px", marginBottom: 16, border: "1px solid #e0d8f0", boxShadow: "0 2px 16px rgba(160,100,200,0.08)" }}>
              ...
              <div style={{ fontSize: 10, color: "#a090b0", marginBottom: 14 }}>あなたと組むと、循環が加速する人の姿</div>
              {needs.length === 0 ? (
                <div style={{ fontSize: 12, color: "#c0a8d0", lineHeight: 1.6 }}>
                  「才能パズルを見る」から診断すると、ここにあなたを補完する才能が表示されます🌱
                </div>
              ) : (
                <>
        ...
        {history.some(h => h.aiFallback) && (
          <div style={{ marginTop: 8, padding: "14px 16px", borderRadius: 16, background: `${COLORS.goldPrimary}18`, border: `1px solid ${COLORS.goldPrimary}44` }}>
            <div style={{ fontSize: 14, fontWeight: 700, color: COLORS.goldLight, letterSpacing: 1, marginBottom: 4 }}>AI判定<span style={{ fontSize: 10, fontWeight: 400, color: COLORS.mutedText, marginLeft: 6 }}>（有料プラン予定）</span></div>
    ...
    <div
                      ...
                      <div key={sub}>
                        <button onClick={() => {
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            <span style={{ fontSize: 22 }}>{isOther ? "✏️" : (SUB_EMOJI[sub] || "✦")}</span>
                            <span>{sub}</span>
                          </div>
      ...
      {inputStep !== "sub" && <div style={{
        ...
        <button onClick={() => {
          ...
          <span style={{ fontSize: 24, fontWeight: 700, color: "#333" }}>↩</span>
                ...
                <div key={s.step} style={{ display: "flex", gap: 12, marginBottom: 0, alignItems: "stretch" }}>
                  ...
                  <div style={{ paddingBottom: i < arr.length - 1 ? 16 : 0 }}>
                    <div style={{ fontSize: 13, fontWeight: 700, color: s.col, marginBottom: 3 }}>
                      Step {s.step}｜{s.title}
                      {s.premium && (
                        <span style={{ fontSize: 10, fontWeight: 600, color: COLORS.mutedText, marginLeft: 6 }}>（有料プラン予定）</span>
                      )}
                    </div>
