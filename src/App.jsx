      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 20 }}>
        ...
        {inputStep === "loading" && aiLoading && (() => {
          ...
          const LoadingCountdown = () => {
            ...
            const HOLD_AT_1_MS = 900; // 「1」が出てから消えるまでの間（フェードアウトの尺と揃える）
            ...
            return (
              <div style={{
                ...
                <div key={count} style={{
                  ...
                  opacity: 0.4,
                  animation: count === 1 ? `countFadeOut ${HOLD_AT_1_MS}ms both` : "bounceIn 1s both",
                }}>{count}</div>
              </div>
            );
          };
  ...
  return (
    <div onClickCapture={handleGlobalClick} style={{
      ...
      <style>{`
        ...
        @keyframes countFadeOut { 0%{transform:scale(1);opacity:0.4} 30%{transform:scale(1.15);opacity:0.4} 100%{transform:scale(1.4);opacity:0} }
