...
// ─── Future Updates Panel（今後の展開・メール登録／補完ピース図鑑の下に常設）────
function FutureUpdatesPanel() {
  ...
  return (
    <div style={{ background: "white", borderRadius: 20, padding: "16px 18px", marginBottom: 16, border: "1px solid #e0d8f0", boxShadow: "0 2px 16px rgba(160,100,200,0.08)" }}>
      ...
      {open && (
        <div style={{ marginTop: 14, animation: "slideUpIn 0.4s cubic-bezier(0.16,1,0.3,1)" }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#c49a2a", marginBottom: 8, lineHeight: 1.7 }}>
            ・アプリがあなたと相性の良い人を自動で見つける
          </div>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#c07fb0", marginBottom: 12, lineHeight: 1.7 }}>
            ・見つかったら、お互いに自動で通知が届く
          </div>
          <div style={{ fontSize: 11, color: "#5a4a68", lineHeight: 1.8, marginBottom: 14 }}>
            時期はまだ確定していませんが、このようなヴァージョンアップを考えています。<br />
            この機能が始まったらいち早く知りたい方は、メールアドレスをご登録ください。
          </div>
          {!submitted ? (
            <>
  ...
  const ReportTab = () => {
    ...
    return (
      <div style={{ padding: "20px 20px 100px" }}>
        ...
        {/* 今後の展開（クリックで開閉）＋メール登録（Lv5演出からは独立） */}
        {level >= 5 && <FutureUpdatesPanel />}
