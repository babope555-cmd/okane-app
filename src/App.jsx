  ...
  return (
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{
          fontSize: 29, fontWeight: 900, whiteSpace: "nowrap",
...
export default function App() {
  ...
  // ── 起動時の自動修正：過去のバグ等でenergyとlevelが噛み合っていない場合に補正 ──
  useEffect(() => {
    const correctLevel = LEVELS.reduce((best, l) => energy >= l.needed ? l : best, LEVELS[0]).lv;
